 ...
 * @constructor
 */
var DockerAPI = function (app, docker_driver, docker_infos) {
  this.app = app
...
DockerAPI.prototype.getDockerodeInstance = function () {
  ...
  if (this.instance === undefined) {
    ...
    this.instance = new (this.dockerDriver)({
      protocol: 'https',
      host: this.dockerInfos.hostname,
      port: this.dockerInfos.port,
  ...
  return new Promise(function (resolve, reject) {
    this.getDockerodeInstance()
      ...
      .inspect(function (err, data) {
        ...
        resolve(new DockerContainer(this.app, this.dockerInfos, container, data))
      }.bind(this))
  }.bind(this))
}
