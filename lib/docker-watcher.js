 ...
 * @constructor
 */
var DockerWatcher = function (docker_driver, docker_infos, flags, interval) {
  EventEmitter.call(this)
  this.dockerInfos = docker_infos
  this.dockerAPI = new DockerAPI(docker_driver, this.dockerInfos)
  this.containers = []
  this.interval = interval || 200
  this.flags = flags || DockerContainer.HAS_PROXY_ENABLED | DockerContainer.IS_RUNNING
}
